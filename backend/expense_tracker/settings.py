...
SECRET_KEY = os.getenv('SECRET_KEY', 'super-secret-jwt-key-expense-tracker-2026')
DEBUG = True
ALLOWED_HOSTS = ['*']
...
if db_url.startswith('mysql'):
    cleaned_url = db_url.replace('mysql+pymysql://', 'http://').replace('mysql://', 'http://')
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': BASE_DIR / 'instance' / 'expense_tracker.db',
        }
    }
